 ...
 */
public abstract class AbstractAllCodePointsEvaluated extends
		AbstractContextualRule {

	/**
	 * By default this method return <tt>true</tt>.
	 */
	@Override
	public boolean allCodePointsEvaluated () {
		return ContextualRule.ALL_CODE_POINTS_EVALUATED_TRUE;
	}
