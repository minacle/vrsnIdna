...
public interface TCharCollection extends Serializable {
	 ...
	 * 
	 * @param array
	 *        a <code>array</code> of char primitives.
	 ...
	 * 
	 * @param collection
	 *        a <code>TCharCollection</code> value
	 * @return true if the collection was modified by the add all operation.
	 */
	...
	/**
	 * Tests the collection to determine if all of the elements in <tt>array</tt>
	 * are present.
	 * 
	 * @param array
	 *        as <code>array</code> of char primitives.
	 ...
	 * <tt>true</tt> if the specified object is also a collection, the two
	 ...
	 * collection is contained in the specified collection). This definition
	 ...
	 * 
	 * @param procedure
	 *        a <code>TCharProcedure</code> value
	 ...
	 * collection is defined to be the sum of the hash codes of the elements in
	 * the collection. This ensures that <tt>s1.equals(s2)</tt> implies that
	 ...
	 * 
	 * @param array
	 *        an <code>array</code> of char primitives.
	...
	/**
	 * Removes all of the elements in <tt>TCharCollection</tt> from the
	 * collection.
	 * 
	 * @param collection
	 *        a <code>TCharCollection</code> value
	 ...
	 * this collection contains more than <tt>Integer.MAX_VALUE</tt> elements,
	 ...
	 * <tt>{@link #getNoEntryValue()}</tt>. (This is useful in determining the
	 * length of this collection <i>only</i> if the caller knows that this
