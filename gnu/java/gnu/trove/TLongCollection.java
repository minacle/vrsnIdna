...
public interface TLongCollection extends Serializable {
	 ...
	 * 
	 * @param array
	 *        a <code>array</code> of long primitives.
	 * @return true if the collection was modified by the add all operation.
	 */
	 ...
	 * 
	 * @param collection
	 *        a <code>TLongCollection</code> value
	 * @return true if the collection was modified by the add all operation.
	 */
	 ...
	 * 
	 * @param array
	 *        as <code>array</code> of long primitives.
	 * @return true if all elements were present in the collection.
	 */
	 ...
	 * 
	 * @param array
	 *        an <code>array</code> of long primitives.
	 * @return true if the collection was modified by the remove all operation.
	 */
	...
	/**
	 * Removes all of the elements in <tt>TLongCollection</tt> from the
	 * collection.
	 * 
	 * @param collection
	 *        a <code>TLongCollection</code> value
