...
public abstract class THashIterator<V> implements TIterator, Iterator<V> {
	 ...
	 *         if the structure was changed using a method that isn't on this
	 *         iterator.
	...
	/**
	 * Returns the object at the specified index. Subclasses should implement this
	 * to return the appropriate object for the given index.
	 * 
	 * @param index
