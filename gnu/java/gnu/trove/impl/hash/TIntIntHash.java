...
abstract public class TIntIntHash extends TPrimitiveHash {
	...
	/**
	 * key that represents null NOTE: should not be modified after the Hash is
	...
	/**
	 * Creates a new <code>T#E#Hash</code> instance with the default capacity and
	 * load factor.
	 */
	public TIntIntHash () {
		super();
	 ...
	 */
	public TIntIntHash ( int initialCapacity, float loadFactor, int no_entry_key,
			int no_entry_value ) {
		super( initialCapacity, loadFactor );
