...
/**
 * An open addressed hashing implementation for long primitives. Created: Sun
 * Nov 4 08:56:06 2001
 * 
...
abstract public class TLongHash extends TPrimitiveHash {
	...
	/**
	 * value that represents null NOTE: should not be modified after the Hash is
	 * created, but is not final because of Externalization
	 */
	protected long no_entry_value;


	/**
	 * Creates a new <code>TLongHash</code> instance with the default capacity and
	 * load factor.
	 */
	public TLongHash () {
		super();
	...
	/**
	 * Creates a new <code>TLongHash</code> instance whose capacity is the next
	...
	/**
	 * Creates a new <code>TLongHash</code> instance with a prime value at or near
	 ...
	 * already a value equal()ing <tt>val</tt> in the set, returns that value as a
	 * negative integer.
	 * 
	 * @param val
	 *        an <code>long</code> value
