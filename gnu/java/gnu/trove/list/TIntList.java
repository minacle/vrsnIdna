...
public interface TIntList extends TIntCollection, Serializable {
	...
	/**
	 * Performs a binary search for <tt>value</tt> in the specified range. Note
	 * that you <b>must</b> @{link #sort sort} the list or the range before doing
	 * a search.
	 * 
	 * @param value
	 *        the value to search for
	...
	/**
	 * Flushes the internal state of the list, resetting the capacity to the
	 * default.
	 */
	public void clear ();
	...
	/**
	 * Searches the list for values satisfying <tt>condition</tt> in the manner of
	 * the *nix <tt>grep</tt> utility.
	 * 
	 * @param condition
	...
	/**
	 * Inserts the array of <tt>values</tt> into the list at <tt>offset</tt>. All
	 * values including and to the right of <tt>offset</tt> are shifted to the
	 * right.
	 * 
	 * @param offset
	 *        an <code>int</code> value
	...
	/**
	 * Inserts a slice of the array of <tt>values</tt> into the list at
	...
	/**
	 * Searches the list for values which do <b>not</b> satisfy <tt>condition</tt>
	 ...
	 * 
	 * @param offset
	 *        an <code>int</code> value that represents the offset to the element
	 *        to be removed
	 ...
	 * following the end of the list is set to <tt>{@link #getNoEntryValue()}</tt>
	 ...
	 * <p>
	 * NOTE: Trove does not allocate a new array if the array passed in is not
	 * large enough to hold all of the data elements. It will instead fill the
	 * array passed in.
	 * 
	 * @param dest
	 ...
	 *        the offset of the first value to copy
	 * @param dest_pos
	 *        the offset where the first value should be copied
	 * @param len
	 *        the number of values to copy.
	 * @return the array passed in.
	 */
