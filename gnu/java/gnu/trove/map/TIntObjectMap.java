...
public interface TIntObjectMap<V> {
	 ...
	 * 
	 * @param procedure
	 *        a <code>TIntObjectProcedure</code> value
	...
	/**
	 * Returns a <tt>TIntObjectIterator</tt> with access to this map's keys and
	 * values.
	 * 
	 * @return a <tt>TIntObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	...
	/**
	 * Returns a {@link TIntSet} view of the keys contained in this map. The set
