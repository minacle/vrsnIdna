...
public interface TLongObjectMap<V> {
	 ...
	 * mapping for a key <tt>k</tt> such that <tt>key.equals(k)</tt>. (There can
	 ...
	 * different implementations of the <tt>Map</tt> interface.
	 * 
	 * @param o
	 ...
	 * 
	 * @param procedure
	 *        a <code>TLongObjectProcedure</code> value
	...
	/**
	 * Returns the value that represents null in the {@link #keySet()}. The
	 * default value is generally zero, but can be changed during construction of
	 * the collection.
	 * 
	...
	/**
	 * Returns a <tt>TLongObjectIterator</tt> with access to this map's keys and
	 * values.
	 * 
	 * @return a <tt>TLongObjectIterator</tt> with access to this map's keys and
	 *         values.
	 */
	...
	/**
	 * Returns a copy of the keys of the map as an array. Changes to the array of
	 * keys will not be reflected in the map nor vice-versa.
	 * 
	...
	/**
	 * Returns a {@link TLongSet} view of the keys contained in this map. The set
	 ...
	 * {@link #containsKey(long) m.containsKey(k)} would return <tt>true</tt>.)
	 * 
	 * @param key
	 *        key with which the specified value is to be associated
	 * @param value
	 *        an <tt>long</tt> value value to be associated with the specified key
	 ...
	 *         stored in this map
	 * @throws NullPointerException
	 *         if the specified key or value is null and this map does not permit
	 *         null keys or values
	 ...
	 * {@link #put(long,Object) put(k, v)} on this map once for each mapping from
	 ...
	 *        key with which the specified value is to be associated
	 * @param value
	 *        an <tt>long</tt> value to be associated with the specified key
	...
	/**
	 * Returns the values of the map as an array of <tt>long</tt> values. Changes
	 * to the array of values will not be reflected in the map nor vice-versa.
	 * 
	...
	/**
	 * Returns the values of the map using an existing array. Changes to the array
	 * of values will not be reflected in the map nor vice-versa.
	 * 
	 * @param array
	 *        the array into which the elements of the list are to be stored, if
	 *        it is big enough; otherwise, a new array of the same type is
