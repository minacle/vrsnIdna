...
public interface TObjectIntMap<K> {
	 ...
	 * 
	 * @param value
	 *        <tt>int</tt> value whose presence in this map is to be tested
	...
	/**
	 * Returns a <tt>TObjectIntIterator</tt> with access to this map's keys and
	 * values.
	 * 
	 * @return a <tt>TObjectIntIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 * @param value
	 *        an <tt>int</tt> value value to be associated with the specified key
	 ...
	 * {@link #put(Object,int) put(k, v)} on this map once for each mapping from
	 ...
	 */
	void putAll ( TObjectIntMap<K> map );
	 ...
	 * <tt>TIntCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
	...
	/**
	 * Returns the values of the map as an array of <tt>int</tt> values. Changes
