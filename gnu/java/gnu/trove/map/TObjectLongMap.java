...
public interface TObjectLongMap<K> {
	 ...
	 * <tt>(value==no_entry_value ? v==no_entry_value : value.equals(v))</tt>.
	 * This operation will probably require time linear in the map size for most
	 * implementations of the <tt>Map</tt> interface.
	 *<p/>
	 * Note that no_entry_value is the result of {@link #getNoEntryValue()} and
	 * represents null for this map instance.
	 * 
	 * @param value
	 *        <tt>long</tt> value whose presence in this map is to be tested
	...
	/**
	 * Returns a <tt>TObjectLongIterator</tt> with access to this map's keys and
	 * values.
	 * 
	 * @return a <tt>TObjectLongIterator</tt> with access to this map's keys and
	 *         values.
	 */
	 ...
	 * {@link #put(Object,long) put(k, v)} on this map once for each mapping from
	 ...
	 */
	void putAll ( TObjectLongMap<K> map );
	 ...
	 * <tt>TLongCollection.remove</tt>, <tt>removeAll</tt>, <tt>retainAll</tt> and
